...
class SpotifyRequest : public SpotifyBaseRequest {
 ...
 private slots:
  ...
  void AlbumsReceived(QNetworkReply *reply, const Artist &artist, const int limit_requested, const int offset_requested);
 ...
 private:
  ...
  QString ParseSong(Song &song, const QJsonObject &json_obj, const Artist &album_artist, const Album &album);
